...
<head>
    ...
    <style>
        ...
        .analysis-box { margin-top: 2.5rem; padding: 1.5rem; background-color: #f9f9f9; border-radius: 8px; border-left: 5px solid #007bff; }
        .analysis-box h2 { text-align: left; margin-top: 0; }
        .analysis-box pre { white-space: pre-wrap; word-wrap: break-word; font-family: 'SF Mono', 'Menlo', 'Monaco', monospace; font-size: .9rem; line-height: 1.6; color: #333; }
...
def position_status_page():
    ...
    market_regime = 'N/A' if btc_series.empty else regime_detector.get_market_regime(btc_series)
    ...
    _, _, analysis_comments = scorer.calculate_total_score(
        {'symbol': 'BTC', 'id': 'bitcoin'}, 'BTC-USD', sentiment_data, market_regime
    )
